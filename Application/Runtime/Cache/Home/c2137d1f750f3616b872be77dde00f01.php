  ...
  <div id="main-content"> 
   ...
   <div class="cf"> 
    ...
    <div class="search-form fr cf"> 
     <div class="sleft"> 
      <input type="text" name="public_name" class="search-input" value="" placeholder="请输入关键字" /> 
   ...
   <div class="data-table"> 
    <div class="data-table table-striped"> 
     <table> 
      ...
      <tbody> 
       <tr> 
        <td><input class="ids" type="checkbox" value="75" name="ids[]" /></td> 
        <td>海边的海星</td> 
        <td>star</td> 
        <td>250</td> 
        <td>3600</td> 
        <td> <a href=" ">编辑</a> <a href=" ">查看详情</a> <a href=" ">删除</a> </td> 
       </tr> 
      </tbody> 
     </table> 
    </div> 
